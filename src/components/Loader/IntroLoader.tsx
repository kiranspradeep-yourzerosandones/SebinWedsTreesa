            ...
            {stage === "verse" && (
              ...
              >
                <div className="flex flex-col items-center justify-center text-center w-full max-w-md px-8">
                  ...
                  >
                    എൻ ആത്മാവ് സ്നേഹിച്ചവനെ ഞാൻ കണ്ടെത്തി
                  </motion.p>
                  ...
                  >
                    &ldquo;I have found one whom my soul loves&rdquo;
                  </motion.p>
...
/* ──────────────────────────────────────────────────────────
   DECORATIVE SVG COMPONENTS (used inside loader only)
────────────────────────────────────────────────────────── */
...
// type PageState = "loader" | "hero" | "exit";

// export default function Hero() {
//   const { couple, event } = weddingData;
//   const [pageState, setPageState] = useState<PageState>("loader");
//   const [petals, setPetals] = useState<Petal[]>([]);
//   const [hasMounted, setHasMounted] = useState(false);
...
//         {pageState === "loader" && (
//           <IntroLoader onComplete={() => setPageState("hero")} />
//         )}
//       </AnimatePresence>
...
// /* ──────────────────────────────────────────────────────────
//    INTRO LOADER — COMPLETELY REWRITTEN
//    Both stages use FIXED POSITIONING & GUARANTEED CENTERING
// ────────────────────────────────────────────────────────── */
...
//           {/* ═══════════════════════════════════════════════════════
//               VERSE STAGE — Fixed position, perfectly centered
//               ═══════════════════════════════════════════════════════ */}
//           <AnimatePresence>
//             {stage === "verse" && (
//               <motion.div
...
//           {/* ═══════════════════════════════════════════════════════
//               CARD STAGE — Fixed position, scrolls UP from BOTTOM
//               ═══════════════════════════════════════════════════════ */}
//           <AnimatePresence>
//             {stage === "card" && (
//               <motion.div
